  ...
  projects: [
    {
      ...
      description: "A full-featured online shopping platform with product management, cart functionality, and secure checkout process.",
    ...
    },
    {
      ...
      description: "A mobile application that helps users organize tasks, set reminders, and track progress with intuitive UI.",
    ...
    },
    {
      ...
      description: "An interactive dashboard that visualizes complex data with charts, graphs, and filtering capabilities.",
      technologies: ["Vue.js", "D3.js", "Express", "PostgreSQL"],
      link: "https://github.com/johndoe/analytics",
      iconPath: "M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm2 4h10v2H7V7zm0 4h5v2H7v-2z"
    },
    {
      title: "Social Networking Platform",
      description: "A feature-rich social platform allowing users to connect, share content, and interact in real-time.",
      technologies: ["React.js", "GraphQL", "Apollo", "MongoDB"],
      link: "https://github.com/johndoe/socialnetwork",
    ...
    },
    {
      ...
      description: "A health and fitness application that tracks workouts, monitors progress, and provides personalized recommendations.",
      technologies: ["Flutter", "Firebase", "Machine Learning"],
      link: "https://github.com/johndoe/fitness",
    ...
    },
    {
      ...
      description: "A beautiful weather application providing accurate forecasts, radar maps, and weather alerts with intuitive visualizations.",
      technologies: ["JavaScript", "OpenWeather API", "Leaflet.js"],
